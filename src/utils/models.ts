...
export const AVAILABLE_MODELS: ModelInfo[] = [
  ...
  // === GPT-5.5 / GPT-5.4 (API — aligned with Cost Katana backend) ===
  {
    ...
    isLatest: true,
    notes:
      'GPT-5.5 flagship. Standard: $5.00/$30.00 per 1M tokens. ~1.05M context — verify on OpenAI pricing',
  },
  {
    ...
    category: 'text',
    isLatest: true,
    notes: 'Dated snapshot of GPT-5.5. $5.00/$30.00 per 1M tokens',
  },
  {
    id: 'gpt-5.5-pro',
    name: 'GPT-5.5 Pro',
    ...
    category: 'text',
    isLatest: true,
    notes: 'Higher-throughput GPT-5.5. Standard: $30.00/$180.00 per 1M tokens',
  },
  {
    id: 'gpt-5.4',
    name: 'GPT-5.4',
    ...
    category: 'text',
    isLatest: true,
    notes: 'GPT-5.4. Standard: $2.50/$15.00 per 1M tokens. 256K context',
  },
  {
    id: 'gpt-5.4-mini',
    name: 'GPT-5.4 mini',
    ...
    isLatest: true,
    notes:
      'Efficient GPT-5.4. Standard: $0.75/$4.50 per 1M tokens. 256K context',
  },
  ...
  // === GPT-5 Models ===
  {
    ...
    isLatest: true,
    notes:
      'GPT-5 family id — align with live API id. Standard: $5.00/$30.00 per 1M tokens (~1.05M context in Cost Katana). Verify batch/flex on OpenAI',
  },
  {
    id: 'gpt-5-mini',
    name: 'GPT-5 mini',
    ...
    isLatest: true,
    notes:
      'Efficient GPT-5-class model. Standard: $0.75/$4.50 per 1M tokens. 256K context',
  },
  {
    id: 'gpt-5-nano',
    name: 'GPT-5 nano',
    ...
    isLatest: true,
    notes:
      'Smallest GPT-5-class tier. Standard: $0.20/$0.80 per 1M tokens (estimate — verify on OpenAI). 128K context',
  },
  {
    id: 'gpt-5-pro',
    name: 'GPT-5 pro',
  ...
  },
  {
    ...
    isLatest: true,
    notes:
      'Chat-optimized GPT-5. Standard: $5.00/$30.00 per 1M tokens (~1.05M context)',
  },
  {
    ...
    category: 'text',
    isLatest: true,
    notes: 'Rolling chat alias for GPT-5. Standard: $5.00/$30.00 per 1M tokens',
  },
  ...
  // === Claude Opus 4.6 Series (Latest) ===
  {
    ...
    isLatest: true,
    notes:
      'Claude Opus 4.6 (Messages API). $5/$25 per 1M. 200K context in Cost Katana; max output 64K — verify on docs.anthropic.com',
  },
  {
    id: 'claude-opus-4-6',
  ...
  },
  {
    ...
    isLatest: true,
    notes:
      'Claude Opus 4.7 — same list pricing tier as 4.6 ($5/$25 per 1M). 200K context in Cost Katana',
  },
  ...
  },
  {
    ...
    pricing: { input: 0.35, output: 2.8 },
    capabilities: ['text', 'vision', 'audio', 'fast', 'multimodal'],
    category: 'multimodal',
    isLatest: true,
    notes:
      'Gemini 3 Flash preview. Indicative headline: $0.35/$2.80 per 1M (aligned with Cost Katana backend). 1M context — confirm on Google AI pricing',
  },
  {
    id: 'gemini-3.1-pro',
    name: 'Gemini 3.1 Pro',
    ...
    isLatest: true,
    notes:
      'Gemini 3.1 Pro — same headline tier as Gemini 3 Pro in Cost Katana ($2/$12 per 1M). Verify live model id on ai.google.dev / Vertex',
  },
  ...
  },
  {
    ...
    isLatest: true,
    notes:
      'Claude Opus 4.6 on AWS Bedrock — ~1M context profile in Cost Katana. $5/$25 per 1M — verify inference profile id',
  },
  {
    ...
    isLatest: true,
    notes:
      'Claude Opus 4.7 on Bedrock — verify exact modelId when AWS publishes. $5/$25 per 1M tier aligned with Anthropic GA',
  },
  {
